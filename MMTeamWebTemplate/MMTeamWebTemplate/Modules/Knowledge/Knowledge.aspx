...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitleInTitleArea" runat="server">
		Knowledge <SharePoint:FieldValue id="PageTitle" FieldName="Title" runat="server"/>
</asp:Content>
...
<asp:Content ID="Content12" runat="server" ContentPlaceHolderID="PlaceHolderMain">
  ...
  <table border="0" cellpadding="4" cellspacing="0" width="100%">
        <tr>
            <td id="tlc" height="100%" name="_invisibleIfEmpty" valign="top" style="width:33%">
            ...
            <td id="tmc" height="100%" name="_invisibleIfEmpty" valign="top" style="width:33%">
                <WebPartPages:WebPartZone ID="TopMiddleColumn" runat="server" FrameType="TitleBarOnly" Title="Top Left Column"></WebPartPages:WebPartZone></td>
            <td id="trc" height="100%" name="_invisibleIfEmpty" valign="top" style="width:33%">
        ...
        <tr>
            <td id="blc" height="100%" name="_invisibleIfEmpty" valign="top" style="width:33%">
            ...
            <td id="bmc" height="100%" name="_invisibleIfEmpty" valign="top" style="width:33%">
                <WebPartPages:WebPartZone ID="BottomMiddleColumn" runat="server" FrameType="TitleBarOnly" Title="Top Left Column"></WebPartPages:WebPartZone></td>
            <td id="brc" height="100%" name="_invisibleIfEmpty" valign="top" style="width:33%">
